...
if ($_GET) {
    ...
    $sql = "select * ";
    $sql .= "from coupons_schools where status = '1' and news_category =:category_id and language = 0 order by news_id asc LIMIT $start_from, $limit";
