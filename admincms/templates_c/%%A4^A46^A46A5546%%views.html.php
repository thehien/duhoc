<?php /* Smarty version 2.6.13, created on 2017-11-25 18:07:55
...
<em>*</em></span></td>
          <td><input type="text" class="check_input" name="category_name"  id="category_name" value="<?php echo $this->_tpl_vars['rs_edit']['category_name']; ?>
" /></td>
        </tr>
        <tr>
          <td align="right"><span><?php echo @langcms_linkdm; ?>
</span></td>
          <td><input class="check_url" type="text" name="category_url"  id="category_url" value="<?php echo $this->_tpl_vars['rs_edit']['category_url']; ?>
...
" <?php if ($this->_tpl_vars['val']['category_id'] == $_SESSION['info']['parent_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['val']['category_name']; ?>
		...
		<tr>
            ...
            <input type="hidden" name="image_old" id="image_old" value="<?php echo $this->_tpl_vars['rs_edit']['category_img']; ?>
" />
...
" placeholder="Ex: www.web.com"/></td>
    	...
    	<tr>
          ...
          <td><textarea class="form-control" rows="5" name="category_content"  id="category_content" ><?php echo $this->_tpl_vars['rs_edit']['category_content']; ?>
</textarea></td>
        </tr>  
...
" class="wnum" /></td>
          ...
          <td><input type="text" name="total_percent" id="total_percent" maxlength="2" class="check_num wnum" value="<?php echo $this->_tpl_vars['rs_edit']['total_percent']; ?>
" /></td>
        </tr>
        <tr>
...
" maxlength="3"/></td>
    	...
    	<tr>
            ...
            <td colspan="3"><input type="text" name="seo_title"  id="seo_title" value="<?php echo $this->_tpl_vars['rs_edit']['seo_title']; ?>
" placeholder="Seo H1"  /></td>
        </tr>
        <tr>
            <td align="right"><span>Meta Keywords</span></td>
            <td colspan="3"><input type="text" name="seo_key"  id="seo_key" value="<?php echo $this->_tpl_vars['rs_edit']['seo_key']; ?>
" placeholder="Seo Keywords"  /></td>
        </tr>
    	<tr>
          <td align="right" valign="top"><span>Meta Content</span></td>
          <td colspan="3"><textarea class="form-control" rows="5" name="seo_desc"  id="seo_desc" placeholder="Seo H2" ><?php echo $this->_tpl_vars['rs_edit']['seo_desc']; ?>
</textarea></td>
        </tr>      
      </thead>  
    </table>
...
&order=category_name&sc=asc"><i class="fa fa-caret-up"></i></a>  
          <a href="<?php echo $this->_tpl_vars['url_views'];  echo $this->_tpl_vars['url_limit']; ?>
&order=category_name&sc=desc"><i class="fa fa-caret-down"></i></a>
        </div>
        </td>
        <td align="center" class="mw_100"><?php echo @langcms_loaitin; ?>
</td>
        <td align="center"><?php echo @langcms_giaodien; ?>
</td>
        ...
        <?php if ($this->_tpl_vars['action_edit']): ?><td align="center" class="mw_80"><?php echo @langcms_capnhat; ?>
</td><?php endif; ?>
...
.html" target="_blank">
        ...
        <td align="center">
        <?php if ($this->_tpl_vars['rs']['layout'] == 01): ?>layout 1<?php endif; ?>
        <?php if ($this->_tpl_vars['rs']['layout'] == 02): ?>layout 2<?php endif; ?>
        </td>
...
" class="check_num" 
        <?php if ($this->_tpl_vars['rs']['news_url']): ?>style="display:none"<?php endif; ?> /></td>
