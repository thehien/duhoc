<?php /* Smarty version 2.6.13, created on 2019-03-31 09:25:51
...
"
                            ...
                            <tr>
                                <td align="right"><span>Danh mục khác <em>*</em></span></td>
                                <td>
                                    <select class="select_option check_input" name="other_category" id="other_category">
                                        <option value=""><?php echo @langcms_chondanhmuc; ?>
</option>
                                        <?php $_from = $this->_tpl_vars['tree_select']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['val'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['val']['total'] > 0):
...
?>
                                        <option value="<?php echo $this->_tpl_vars['val']['category_id']; ?>
" <?php if ($this->_tpl_vars['val']['category_id'] == $this->_tpl_vars['rs_edit']['other_category']): ?>selected="selected" <?php endif; ?>><?php echo $this->_tpl_vars['val']['category_name']; ?>
</option>
                                        <?php endforeach; endif; unset($_from); ?>
                                    </select>
                                </td>

                                <td align="right"><span>Hiển thị nổi bật</span></td>
                                <td>
...
" height="50"
                                ...
                                <td align="right"><span>Hiển thị trang chủ</span></td>
                                <td>
