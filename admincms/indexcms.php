...
$msg_time = 2;
define("msg_box_action", langcms_boxkcq . ". <a  href=" . URL_ADMIN . "?module=homes" . "> " . langcms_boxhome . "</a>.");
...
define("msg_box_general_succ", langcms_boxttc . ". <a  href=" . $module_url_general . "> " . langcms_boxchuot . "</a>.");
...
define("msg_box_erro_status", langcms_boxtthtk . ". <a href='javascript:history.go(-1);'> " . langcms_boxchuot . "</a>.");
define("msg_box_erro_parent", langcms_boxvlxh . ". <a href='javascript:history.go(-1);'> " . langcms_boxchuot . "</a>.");
