...
//Insert
  function insert_table($data) {
    ...
    $sql = "INSERT INTO coupons_special_category (
			    id,category_name,category_url,language,status,created_date,img, icon)
				VALUES(NULL,'" . $data['category_name'] . "','" . $data['category_url'] . "',	'" . $data['language'] . "',  '" . $data['status'] . "','$created_date',  '" . $data['img'] . "',  '" . $data['icon'] . "')";
...
//Edit
  ...
  function edit_table($id, $data){
    ...
    $sql = "Update coupons_special_category set category_name ='" . $data['category_name'] . "',category_url ='" . $data['category_url'] . "', img ='" . $data['img'] . "', icon ='" . $data['icon'] . "',status ='" . $data['status'] . "' where id='$id' ";
