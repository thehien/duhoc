...
//Views
    function num_views($name_search, $category)
    {
        ...
        $sql = "SELECT a.news_id FROM coupons_contents a, coupons_category b 
    ...
    function views_table($page, $per_page, $order, $sc, $name_search, $category)
    {
		...
		FROM coupons_contents a, coupons_category b where a.news_id >= '1' and a.news_category = b.category_id 
...
//Insert
    function insert_table($data)
    {
        ...
        $created_date = time();
        $sql = "INSERT INTO coupons_contents(news_id,news_name,news_category,news_url,news_link,news_img,news_content,description,
