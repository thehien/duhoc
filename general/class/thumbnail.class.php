...
class Thumbnail
{
    ...
    function Create($dest = '')
    {
        ...
        if (function_exists("ImageCreateTrueColor")) //$img_des = @ImageCreateTrueColor ( $this->GetThumbData('width'), $this->GetThumbData('height') );
        {
            ...
            $img_des = ImageCreate($this->GetThumbData('width'), $this->GetThumbData('height'));
        }
        ...
        ImageCopyResampled($img_des, $img_src, 0, 0, 0, 0, $this->GetThumbData('width'), $this->GetThumbData('height'),
            $this->GetImageData('width'), $this->GetImageData('height'));
