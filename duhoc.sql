...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 17, 2019 lúc 07:27 AM
...
(214, 73, 0, 1, 'Quản lý trường học', 'Quản lý mã vùng', 'schools', 'fa-th-list', 1, 1, 1, 1, 1, 6, 0),
(215, 74, 0, 1, 'Quản lý học viên du học', 'Học viên du học', 'student', 'fa-th-list', 1, 1, 1, 1, 1, 7, 0),
(216, 72, 0, 1, 'Câu hỏi thường gặp', 'Quản lý quốc gia', 'question', 'fa-th-list', 1, 1, 1, 1, 1, 4, 0),
...
(4, 'banner du học mỹ 1', '', '0227-slide1.jpg', 0, '', '', 0, 1, 98, 0),
...
(98, 'Du học mỹ', 'du-hoc-my', 96, '0218-mountain-2.jpg', 3, 1, '', '', '', 0, '<p>Du học mỹ</p>\r\n', '', '', '', 'Du học mỹ', 'Du học mỹ', 'Du học mỹ', '', 0),
...
(103, 'Học bổng', 'hoc-bong', 0, '', 1, 1, '', '', '', 0, '', '', '', '', 'Học bổng', 'Học bổng', 'Học bổng', '', 0),
...
--
ALTER TABLE `coupons_action`
  MODIFY `action_id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=232;

--
-- AUTO_INCREMENT cho bảng `coupons_banner`
--
ALTER TABLE `coupons_banner`
  MODIFY `banner_id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `coupons_category`
--
ALTER TABLE `coupons_category`
  MODIFY `category_id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `coupons_news`
  MODIFY `news_id` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
